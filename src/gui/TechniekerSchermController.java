...
public class TechniekerSchermController extends AnchorPane
{
	@FXML
	...
	private TechniekerController controller;
	
	private ImageView ivImage;
	public TechniekerSchermController(TechniekerController controller) 
	{
		super();
		this.controller = controller;
		try 
		{
			FXMLLoader loader = new FXMLLoader(getClass().getResource("TechniekerScherm.fxml"));
			loader.setController(this);
			loader.setRoot(this);
			loader.load();
			FxmlLoader object = new FxmlLoader();
			OpenstaandeTicketsBeheerController dbs = new OpenstaandeTicketsBeheerController(controller);
			Pane view = object.getPage("OpenstaandeTicketsBeheer", dbs);
	...
	{
		FxmlLoader object = new FxmlLoader();
		AfgehandeldeTicketsBeheerController dbs = new AfgehandeldeTicketsBeheerController(controller);
		Pane view = object.getPage("AfgehandeldeTicketsBeheer", dbs);
		mainPane.setCenter(view);
	}
